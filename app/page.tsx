  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 container-custom text-center text-white animate-fade-in">
          <h1 className="heading-1 mb-6 max-w-4xl mx-auto">
            Designing Spaces That Inspire Excellence
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-neutral-200">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={service.title} className="group cursor-pointer hover:-translate-y-2 transition-transform duration-300">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={project.title} className="group relative h-96 overflow-hidden rounded-sm cursor-pointer">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
